import { levelAccuracy, mockStudents, participation } from "../data/mockClassData";
...
export function ParticipationDonut() {
  const gradient = `conic-gradient(${participation
    .map((item, index) => {
      const start = participation.slice(0, index).reduce((sum, segment) => sum + segment.percent, 0);
      ...
      <div className="mt-7 grid gap-6 sm:grid-cols-[180px_1fr] sm:items-center">
        ...
        >
          <div className="flex h-24 w-24 flex-col items-center justify-center rounded-full bg-white">
            <span className="text-4xl font-black text-ink">38</span>
            ...
            <div className="flex items-center gap-3">
              ...
              <span>
                ...
                <span className="text-xs font-bold text-slate-500">
                  ⭐ {student.stars} · 进度 {student.progress}/5
                </span>
              </span>
            </div>
