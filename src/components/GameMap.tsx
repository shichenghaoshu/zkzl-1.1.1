...
export function GameMap({ onSelect }: GameMapProps) {
  return (
    <section className="game-card min-h-[520px] bg-gradient-to-br from-sky-200 via-blue-100 to-emerald-100 p-5">
      ...
      <div className="relative z-10 flex flex-col gap-4">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <h2 className="text-4xl font-black text-white drop-shadow-[0_3px_0_rgba(47,123,255,0.55)] sm:text-5xl">
              分数王国大冒险
            </h2>
            <p className="mt-2 inline-flex rounded-full bg-white/88 px-4 py-2 text-base font-black text-skybrand shadow-md">
              闯关学分数，成为分数小达人！
            </p>
          </div>
          <div className="rounded-3xl bg-white/88 px-4 py-3 text-right shadow-lg">
            ...
            <div className="text-2xl font-black text-mintbrand">4/5 关</div>
          </div>
        </div>
